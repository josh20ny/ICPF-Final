...
mainPlot.Title.String = ['Time = 20.0 Days. Brain MRI slices along Z-direction, Rat W09. No radiation treatment']; % set the title of the figure
...
for irow = nrow:-1:1
    for icol = 1:ncol
        ...
        imagesc(cells(:,:,sliceNumber,7),colorLimits);
        hold on;
        if icol~= 1
            subPlot.YTickLabels = [];
        end
...
saveas(gcf,'PlotAtDay20.png');        % save the figure